    ...
    fetch(`${baseUrl}/selecteduser`)
        ...
        .then(data => {
            data.users.forEach(user => {
                ...
                li.innerHTML = `<input type="checkbox"> ${user.player_name}- ${user.bluboy_id}`
                userList.appendChild(li);
            });
            originalUserCount = data.users.length; // Set the original total number of users
...
// Fetch and populate the template dropdown
